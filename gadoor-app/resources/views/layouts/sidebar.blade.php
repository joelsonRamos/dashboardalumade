  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{route('Painel.index')}}" class="brand-link text-center">
      {{-- <img src="{{asset('AdminLTE/dist/img/logo_gadoor.png')}}" alt="Gadoor Logo" class="brand-image  elevation-3" style="opacity: .8"> --}}
      <span class="brand-text font-weight-light ">Gadoor</span>
    </a>
